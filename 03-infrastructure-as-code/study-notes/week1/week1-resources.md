# Week 1: Terraform Fundamentals - Daily Resources

## 📅 **Week Overview**

**Focus:** Master Terraform basics, write first configurations, deploy to AWS  
**Duration:** 7 days  
**Success Metric:** Deploy static website using Terraform
