...
# 1. Look up the role that now lives in the Global folder
data "aws_iam_role" "shared_role" {
  name = "GitHubAction-Terraform-Managed-Role"
}

# 2. Look up your Account ID dynamically
data "aws_caller_identity" "current" {}

# 3. Create standalone policies (The Lego Bricks)
...
# 4. Attach them to the shared role
